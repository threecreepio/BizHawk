...
namespace BizHawk.Client.EmuHawk.Properties
{
	internal static class Resources {
		...
		private static Bitmap ReadEmbeddedBitmapAt(string embedPath) => new Bitmap(Asm.GetManifestResourceStream($"BizHawk.Client.EmuHawk.Mono.{embedPath}"));
		...
		private static Bitmap ReadEmbeddedBitmap(string filename) => ReadEmbeddedBitmapAt($"{filename}.png");

		/// <param name="filename">Dir separator is '<c>.</c>'. Filename is relative to <c>&lt;NS>/images</c> and omits <c>.ico</c> extension.</param>
		private static Icon ReadEmbeddedIcon(string filename) => new Icon(Asm.GetManifestResourceStream($"BizHawk.Client.EmuHawk.Mono.{filename}.ico"));
		...
		internal static readonly Bitmap addWatch = ReadEmbeddedBitmapAt("addWatch.ico");
		...
		internal static readonly Cursor BlankCursor = new Cursor(Asm.GetManifestResourceStream("BizHawk.Client.EmuHawk.Mono.BlankCursor.cur"));
		...
		internal static readonly Bitmap cdlogger = ReadEmbeddedBitmapAt("cdlogger.ico");
		...
		internal static readonly Lazy<Bitmap> ArcadeController = new Lazy<Bitmap>(() => ReadEmbeddedBitmapAt("ControllerImages.ArcadeController.jpg"));
		...
		internal static readonly Lazy<Bitmap> SaturnController = new Lazy<Bitmap>(() => ReadEmbeddedBitmapAt("ControllerImages.SaturnController.jpg"));
		...
		internal static readonly Bitmap corphawk = ReadEmbeddedBitmapAt("corphawk.jpg");
		...
		internal static readonly Bitmap MoveBottom = ReadEmbeddedBitmapAt("MoveBottom.png");
		...
		internal static readonly Bitmap MoveTop = ReadEmbeddedBitmapAt("MoveTop.png");
		...
		internal static readonly Bitmap Refresh = ReadEmbeddedBitmapAt("Refresh.bmp");
		...
		internal static readonly Bitmap watch = ReadEmbeddedBitmapAt("watch.ico");
